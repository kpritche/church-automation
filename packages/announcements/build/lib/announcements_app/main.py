...
def main() -> None:
    ...
    pro_output_path = output_dir / f"weekly_announcements_{date_str}.pro"
    print(f"   Output: {pro_output_path}")
    generate_pro_file(announcements, str(pro_output_path))
    print(f"\n✓ ProPresenter file created: {pro_output_path}")
