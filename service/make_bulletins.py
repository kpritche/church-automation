...
OUTPUT_DIR = Path("bulletins/output")
QR_CODE_DIR = Path("bulletins/qr_codes")
...
FONT_SEARCH_PATHS = [
    Path("assets/fonts"),
    Path("fonts"),
    Path("bulletins/fonts"),
    Path("service/fonts"),
    Path("..") / "fonts",
    Path("C:/Windows/Fonts"),  # helpful default on Windows if installed system-wide
]
